...
public class MSettingTable extends Table {
    ...
    protected void rebuild() {
        ...
        for (CategorySetting category : categories) {
            table(Tex.pane, t -> {
                t.button(category.localizedName(), Styles.clearTogglePartiali, category::toggle).checked(b -> category.isShown()).growX()
    ...
    public static abstract class BaseSetting {
        ...
        public BaseSetting(String name, Object def) {
            ...
            MindVars.settings.put(name, def, true, true);
        }
...
//            }
        ...
        protected void putSetting(Object value) {
            MindVars.settings.put(name, value, false, true);
        }
    }
    ...
    public static class CheckSetting extends BaseSetting {
        ...
        public void add(Table table) {
            ...
            box.update(() -> box.setChecked(MindVars.settings.getBool(name)));
        ...
        public void change() {
            changed.get(MindVars.settings.getBool(name));
        }
    }
    ...
    public static class SliderSetting extends BaseSetting {
        ...
        public void add(Table table) {
            ...
            slider.setValue(MindVars.settings.getInt(name));
        ...
        public void change() {
            sp.get(MindVars.settings.getInt(name));
        }
    }
}
